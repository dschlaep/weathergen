...
#' 
#'
plot_basinwide_extreme_annual <- function(obsstats, simstats, fig_dir=NULL, filename="3_BasinWide_Trials_AnnualExtremeEvents", vars=c("prcp","tmax","tmin","wind"), return.periods=c(10,30,100)){
  if(!is.null(fig_dir)){
