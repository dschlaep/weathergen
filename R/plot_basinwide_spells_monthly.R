...
#' 
#'
plot_basinwide_spells_monthly <- function(obsstats, simstats, fig_dir=NULL, filename="2_BasinWide_Trials_MonthlySpells", stats=c("mean","stdev","skew"), vars=c("prcp","tmax","tmin"), months=c(1:12), spells=c("wet","dry")){
  if(!is.null(fig_dir)){
