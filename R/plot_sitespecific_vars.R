...
#' @param timestep timestep to be plotted
...
#' 
#'
plot_sitespecific_vars <- function(obsstats, simstats, fig_dir=NULL,  filename="4_Sites_MedianTrials_", timestep="daily", vars=c("prcp","tmax","tmin","wind")){
