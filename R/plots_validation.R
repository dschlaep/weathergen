...
#' @param filename  filename of PDF to create, containing the plot.
...
#' @export
#' @examples
#' plot_basinwide_vars_monthly(obs, sim)
#' 
#'
# plot_basinwide_vars_monthly <- function(obs, sim, fig_dir=NULL, filename="1_BasinWide_Trials_MonthlyVariables", stats=c("mean","stdev","skew"), vars=c("prcp","tmax","tmin"), mo=c(1:12)){
#   if(!is.null(fig_dir)){
#     pdf(width=3*length(vars), height=3*length(stats), file=file.path(fig_dir, paste0(filename, ifelse(nchar(ftag > 0), "_"), ftag, ".pdf")))
#   }
